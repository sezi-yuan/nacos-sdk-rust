use crate::data::model::{Instance, ExpressionSelector, Service, ServiceInfo, Token, BeatAck};
...
pub trait NamingRemote {
    ...
    async fn query_instances(
        &self, namespace_id: &str, service_name: String, clusters: &[&str], healthy_only: bool
    ) -> Result<ServiceInfo>;
    /// 创建新服务
